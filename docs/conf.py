...
intersphinx_mapping = {
    ...
    "typed_descriptors": (
        "https://typed-descriptors.readthedocs.io/en/latest",
        "./intersphinx/typed-descriptors-objects.inv",
    ),
    "optmanage": (
    ...
    "networkx": (
        ...
        "./intersphinx/networkx-objects.inv",
    ),
    "matplotlib": (
    ...
    "opt-einsum": (
        "https://optimized-einsum.readthedocs.io/en/latest/",
        "./intersphinx/opt-einsum-objects.inv",
    ),
    "cotengra": (
        "https://cotengra.readthedocs.io/en/latest/",
        "./intersphinx/cotengra-objects.inv",
    ),
}
